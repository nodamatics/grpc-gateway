create:
	protoc --proto_path=protocol-buffers --go_out=./pb protocol-buffers/cosmos/*.proto
	protoc --proto_path=protocol-buffers --go_out=./pb protocol-buffers/nodamatics/shared.proto
	protoc --proto_path=protocol-buffers --go_out=./pb protocol-buffers/nodamatics/public/staking/islamic.proto
	protoc --proto_path=protocol-buffers --go-grpc_out=./pb protocol-buffers/nodamatics/public/staking/islamic.proto
	...
	--openapiv2_opt grpc_api_configuration=protocol-buffers/nodamatics/grpc-gateway/islamic.config.yaml \
 	protocol-buffers/nodamatics/public/staking/islamic.proto
